...
$(document).ready(function () {
    ...
    //Used js for Left Sliderbar Collapse: only for categories navigation
    $('.block .wjktitle').on('click touch', function () {
        var $this = $(this);
        $this.next('.wjklistbox').slideToggle('slow');
        $this.toggleClass("arrow-up-down");
    });

    //Used to expand the sidebar category navigation
